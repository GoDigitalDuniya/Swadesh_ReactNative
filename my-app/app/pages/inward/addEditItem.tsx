...
export default function AddEditItemComponent({
  itemToEdit,
  onClose,
}: AddEditItemComponentProps) {
  const context = useContext(InwardContext);
  if (!context) {
    Alert.alert(
      "Error",
      "Context not found. Please ensure the parent component is wrapped in InwardContext.Provider."
    );
    return null;
  }
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://nodeapi.godigitalchat.com/swadeshordermanagement/get/products",
        {
          method: "POST",
          headers: {
  ...
  const handleItemChange = (
    field: keyof Omit<InwardItem, "id">,
    value: string
  ) => {
        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.formContainer}>
            <View style={styles.inputGroup}>
              ...
              <Pressable
                style={styles.productSelectInput}
                onPress={() => setProductModalVisible(true)}
              >
                <Text
                  style={[
                    styles.selectText,
                    !currentItem.productName && styles.placeholder,
                  ]}
                  numberOfLines={2}
                >
              ...
              {currentItem.productId && (
                <View style={styles.productDetails}>
                  <Text style={styles.productDetailText}>
                    SKU: {currentItem.sku} | UOM: {currentItem.uom}
                  </Text>
            ...
            <View style={styles.inputRow}>
              <View style={[styles.inputGroup, styles.halfWidth]}>
                <Text style={styles.inputLabel}>
                  Quantity * {currentItem.uom && `(${currentItem.uom})`}
                </Text>
                <TextInput
                  style={styles.textInput}
                  value={currentItem.InQty}
                  onChangeText={(v) => handleItemChange("InQty", v)}
              ...
              <View style={[styles.inputGroup, styles.halfWidth]}>
                ...
                <TextInput
                  ...
                  onChangeText={(v) => handleItemChange("BatchNo", v)}
                />
              </View>
            </View>
            <View style={styles.inputGroup}>
              ...
              <Pressable style={styles.textInput} onPress={toggleMfdDatePicker}>
                <Text
                  style={[
                    styles.selectText,
                    !currentItem.MfdDate && styles.placeholder,
                  ]}
                >
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(v) => handleItemChange("Remarks", v)}
                  ...
                  renderItem={({ item }) => (
                    ...
                    >
                      ...
                      <Text style={styles.modalOptionSubText}>
                        SKU: {item.ProductSku} | UOM: {item.UOM}
                      </Text>
                    </TouchableOpacity>
                  )}
                />
